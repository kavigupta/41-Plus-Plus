...
public class ParserTest {
	...
	public void expressionParserTest() {
		...
		validateExprParse("((the \"n\" th element of (the 3 rd element of \"matrix\"))*23)");
	...
	public void definitionParserTest() {
		...
		validateLineParse("Define a number called \"x\" with a value of ((\"y\"*\"x\")+2).");
		validateLineParse("Define an (array of number) called \"arr\".");
		validateLineParse("Define an (array of number) called \"arr\" with a \"length\" of 2.");
		validateLineParse("Define an (array of (array of number)) called \"arr\" with a \"length\" of 2.");
		validateLineParse("Define a matrix called \"mat\" with a \"width\" of 3 and a \"height\" of \"width\".");
		validateLineParse("Define a (triple of number, number, and number) called \"cuboid\" with a \"width\" of (1*(2+3)),"
	...
	public void reassignmentParserTest() {
		...
		validateLineParse("Set the \"length\" of \"array\" to ((\"x\"*2234543212345)+(34*2)).");
	}
	@Test
	public void functionDefTest() {
		validateLineParse("Define a function called f \"x\" that takes a number called \"x\" and outputs a number.");
		validateLineParse("Define a function called the \"n\" th prime after \"x\" that takes a number called \"n\""
		...
		assertEquals(
				...
				cdLoopLine("Define a function called the \"n\" th prime after \"x\" while logging \"str\" that takes a number called \"n\","
						+ " a string called \"str\", and a number called \"x\" and outputs a number."));
		// more esoteric problems
		validateLineParse("Define a function called procedure \"x\" that takes a number called \"x\".");
		validateLineParse("Define a function called procedure.");
		validateLineParse("Define a function called pi that outputs a number.");
		validateLineParse("Define a function called the sum of \"v1\" and \"v2\" that takes"
				+ " an (array of number) called \"v1\" and an (array of number) called \"v2\""
				+ " and outputs an (array of number).");
		validateLineParse("Define a function called the product of \"v1\" and \"v2\" that takes"
				+ " an (array of number) called \"v1\" and an (array of number) called \"v2\""
	...
	public void structDefTest() {
		...
		validateLineParse("Define a type called pair of \"k\" and \"v\" that contains a \"k\" called \"key\" and a \"v\" called \"value\".");
		validateLineParse("Define a type called pair of \"k\" and \"v\".");
		validateLineParse("Define a type called triple of \"a\", \"b\", and \"c\" that contains an (array of \"a\") called \"arr\".");
	...
	@Test
	public void ifTest() {
		validateLineParse("If (\"x\" is greater than 0): Set the value of \"x\" to 1.");
		validateLineParse("If (\"x\" is greater than 0): Do the following: If (\"y\" is greater than 2):"
				+ " Set the value of \"x\" to 1. That's all. Otherwise: Set the value of \"y\" to 3.");
		validateLineParse("If (\"x\" is greater than 0): Set the value of \"x\" to 1. Otherwise: Set the value of \"x\" to 2.");
		validateLineParse("If (\"x\" is greater than 0): Do the following: Set the value of \"x\" to 1. Tell me what \"x\" is. That's all. Otherwise: Set the value of \"x\" to 2.");
	}
	@Test
	public void whileTest() {
		assertEquals(
				"While (\"i\" is at most 10): "
						...
						+ "Do the following: "
						+ "Perform some function on \"i\". Set the value of \"i\" to (\"i\"+1). "
	...
	private static String cdLoopExpr(String line) {
		return ExpressionParser.parseExpression(
				Tokenizer.tokenize(LiteralToken.entire(line)))
				.toSourceCode();
	}
}
